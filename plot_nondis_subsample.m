    ...
    [w2, cost2, e2] = SGD_LR_miniBatch_private_subsample(y, X, w0, batch_size, interval_between_errorbar);
    priv = cost2;
    e_priv = e2;
    ...
    [w4, cost4, e4] = SGD_LR_nonDisjointBatch_private_subsample(y, X, w0, batch_size, interval_between_errorbar);
    priv_nondis = cost4;
    e_priv_nondis = e4;
